 ...
 *
 * EFFECTS: every low-level neuromodulation effect and what it does in the model runtime,
 *          grounded in neuromod/effects.py.
 * PACKS:   every predefined 'drug' recipe, grounded in packs/config.json, with expected
 *          behavioral artifacts, dose-response findings, and probes.
 *
